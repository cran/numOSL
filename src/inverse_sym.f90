subroutine inverse_sym(mat1,n,ifault)
!--------------------------------------------------------------------
!  Subroutine inverse_col computes the inverse of a symmetric matrix.
!--------------------------------------------------------------------
...
!--------------------------------------------------------------------
    ...
    !
    call syminv(avec, n, cvec, wvec, nullty, ifault)
    !
    do i=1, n
        mat1(i,1:i) = cvec(i*(i+1)/2-i+1:i*(i+1)/2)
    end do
    !
    do i=1, n
        do j=1, n
